...
def build_hymt2_prompt(
    ...
    *,
    ...
    return (
        ...
        "of copying Japanese phrasing. For Chinese, translate Japanese social formulas into "
        "concise natural Chinese instead of translating honorific wording literally. Translate "
        "greetings and conversational formulas by their social function and context, not as "
        "literal time or dictionary fragments, and never invent hospitality details or implied "
        "actions. Never add or remove facts, promises, dates, numbers, "
