...
datas += collect_data_files("pypinyin", excludes=["**/*.pyi", "**/py.typed"])
datas += collect_data_files("anyascii")
datas += collect_data_files("webview", excludes=["**/py.typed"])
...
a = Analysis(
    ...
    excludes=[
        ...
        "aiohttp", "hf_xet", "httptools", "uvloop", "watchfiles", "wsproto",
